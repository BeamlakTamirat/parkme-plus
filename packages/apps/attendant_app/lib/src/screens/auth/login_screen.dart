  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (result.success && result.user != null) {
        // Check if user is an attendant (temporarily disabled for testing)
        // if (result.user!.role != 'attendant') {
        //   _showError('Access denied. This app is for attendants only.');
        //   await authService.signOut();
        //   return;
        // }

        // Refresh providers and navigate
